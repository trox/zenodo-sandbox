...
| `AUTHORS`, `PROVENANCE.md` | Attribution and an honest human/AI authorship account. |
| `REVIEW.md` | Security / harmful-code review (protocol + results). |

## License & provenance

Dedicated to the public domain under [CC0 1.0](LICENSE). The code and docs were
generated by Claude (Anthropic) under human direction and review by P. Troxler;
see [`PROVENANCE.md`](PROVENANCE.md) for the honest split and [`REVIEW.md`](REVIEW.md)
